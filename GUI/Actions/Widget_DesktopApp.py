...
class WidgetDesktopApp(WidgetGeneric):
    '''
    classdocs
    '''


    def __init__(self,main_window,mdiarea,mixer,window_name,xid):
        '''
        Constructor
        '''
        ...
        self._the_widget.SpinBoxFramerate.setValue(self.video_framerate)
        self.mdiarea = mdiarea
        self.set_name("Desktop app")
    ...
    def __create_stream(self):
        ...
        self.source.add_element("ximagesrc", "videosrc")
        self.source.add_element("videoconvert", "videoconvert")
        
        if self.xid!=0:
            self.source.set_property("videosrc", "xid", self.xid)
            
        self.source.set_property("videosrc", "use-damage", False)
        ...
        self.source.link_elements("videosrc", "videoconvert")
    ...
    def set_source_settings(self,source_class):
        source_class.set_source_properties("Desktop App",None,self.window_name)